const repository = require('../models/cidades-repository');
...
module.exports = {
    ...
    create: async (req, res) => {
        ...
        try {
            ...
            const result = await repository.create(cidades);

            //Pego o ID criado (em result[0]) e atribuo no cidades.id
            cidades.id = result[0];
    ...
    update: async (req, res) => {
        ...
        try {
            ...
            await repository.update(cidades);
